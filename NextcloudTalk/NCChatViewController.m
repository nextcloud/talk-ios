...
- (CGFloat)getCellHeightForMessage:(NCChatMessage *)message withWidth:(CGFloat)width
{
    ...
    if (message.file) {
        height += message.file.previewImageHeight == 0 ? kFileMessageCellFilePreviewHeight + 10 : message.file.previewImageHeight + 10; // right(10)
        ...
        if ([NCUtils isImageOrVideoFileType:message.file.mimetype]) {
            height -= ceil(CGRectGetHeight(bodyBounds));
        }
