...
- (void)addButtonPressed
{
    ...
    if (_room && _selectedParticipants.count > 0) {
        ...
        if (_room.type == kNCRoomTypeOneToOne && [[NCDatabaseManager sharedInstance] serverHasTalkCapability:@"conversation-creation-all"] /* kCapabilityConversationCreationAll */) {
